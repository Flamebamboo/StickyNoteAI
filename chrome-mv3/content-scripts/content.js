var content=function(){"use strict";var Z=Object.defineProperty;var tt=(m,l,c)=>l in m?Z(m,l,{enumerable:!0,configurable:!0,writable:!0,value:c}):m[l]=c;var g=(m,l,c)=>tt(m,typeof l!="symbol"?l+"":l,c);var D,q;function m(t){return t}const c=(q=(D=globalThis.browser)==null?void 0:D.runtime)!=null&&q.id?globalThis.browser:globalThis.chrome,$={matches:["<all_urls>"],main(){console.log("🎯 StickyNoteAI v2.1 FIXED MENU POSITIONING - Loading..."),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{M()}):M()}};let s=null,u=!1,b={x:0,y:0},E={x:0,y:0};function M(){console.log("StickyNoteAI: DOM ready, creating widget..."),F(),j(),V(),X()}function F(){const t=document.getElementById("sticky-note-widget");t&&t.remove(),s=document.createElement("div"),s.id="sticky-note-widget",s.innerHTML=`
  ...
  `,document.head.appendChild(e),document.body.appendChild(s),W()}function W(){const t=document.getElementById("main-button"),e=document.getElementById("widget-menu");if(!t||!e)return;let n=0,o={x:0,y:0},i=!1;t.addEventListener("mousedown",r=>{r.preventDefault(),n=Date.now(),o={x:r.clientX,y:r.clientY},i=!1;const p=s.getBoundingClientRect();b.x=r.clientX-p.left,b.y=r.clientY-p.top,t.classList.add("dragging"),document.addEventListener("mousemove",a),document.addEventListener("mouseup",d)}),t.addEventListener("mouseenter",()=>{u||C()}),s==null||s.addEventListener("mouseleave",()=>{u||k()});function a(r){const p=Date.now()-n,x=Math.sqrt(Math.pow(r.clientX-o.x,2)+Math.pow(r.clientY-o.y,2));if(!u&&(x>3||p>100)&&(u=!0,i=!0,k(),document.body.style.cursor="grabbing"),u){const z=r.clientX-b.x,P=r.clientY-b.y;s.style.transform=`translate(${z}px, ${P}px)`,s.style.left="0",s.style.top="0",E={x:z,y:P}}}function d(){document.removeEventListener("mousemove",a),document.removeEventListener("mouseup",d),t.classList.remove("dragging"),document.body.style.cursor="",u&&(s.style.left=E.x+"px",s.style.top=E.y+"px",s.style.transform="",_()),u=!1,setTimeout(()=>{i||C()},50)}e==null||e.addEventListener("click",r=>{const x=r.target.dataset.action;x&&(U(x),k())})}function C(){if(u)return;const t=document.getElementById("widget-menu");t&&t.classList.add("open")}function k(){const t=document.getElementById("widget-menu");t&&t.classList.remove("open")}function U(t){switch(t){case"add":S();break;case"notes":R();break;case"settings":Y();break;case"close":L();break}}function S(){const t=document.createElement("div");t.className="sticky-modal",t.innerHTML=`
  ...
  `,document.body.appendChild(t),setTimeout(()=>t.classList.add("open"),10);const e=t.querySelector(".modal-close"),n=t.querySelector(".save-note"),o=t.querySelector(".cancel-note"),i=t.querySelector(".note-input");function a(){t.classList.remove("open"),setTimeout(()=>t.remove(),300)}e==null||e.addEventListener("click",a),o==null||o.addEventListener("click",a),n==null||n.addEventListener("click",()=>{const d=i.value.trim();d&&(H(d),a())}),document.addEventListener("keydown",function d(r){r.key==="Escape"&&(a(),document.removeEventListener("keydown",d))})}function R(){let t=document.querySelector(".notes-panel");t||(t=document.createElement("div"),t.className="notes-panel",t.innerHTML=`
  ...
  `,document.body.appendChild(t),setTimeout(()=>t.classList.add("open"),10);function e(){t.classList.remove("open"),setTimeout(()=>t.remove(),300)}(n=t.querySelector(".modal-close"))==null||n.addEventListener("click",e),(o=t.querySelector(".close-settings"))==null||o.addEventListener("click",e)}function L(){s&&(s.style.display="none")}function A(){s&&(s.style.display="block")}async function H(t){try{const n=(await c.storage.local.get("stickyNotes")).stickyNotes||[],o={id:Date.now().toString(),content:t,timestamp:new Date().toISOString(),url:window.location.href};n.unshift(o),n.length>50&&n.splice(50),await c.storage.local.set({stickyNotes:n}),console.log("Note saved successfully")}catch(e){console.error("Error saving note:",e)}}async function h(){const t=document.getElementById("notes-list");if(t)try{const n=(await c.storage.local.get("stickyNotes")).stickyNotes||[];if(n.length===0){t.innerHTML='<div style="padding: 20px; text-align: center; color: #999;">No notes yet</div>';return}t.innerHTML=n.slice(0,10).map(o=>`
    ...
    `).join(""),t.querySelectorAll(".note-item").forEach(o=>{o.addEventListener("click",()=>{const i=o.dataset.noteId,a=n.find(d=>d.id===i);a&&O(a)})})}catch(e){console.error("Error loading notes:",e)}}function O(t){var i,a,d,r;const e=document.createElement("div");e.className="sticky-modal",e.innerHTML=`
    <div class="modal-content">
      <div class="modal-header">
