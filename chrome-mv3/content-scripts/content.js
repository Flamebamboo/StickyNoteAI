var content=function(){"use strict";var Z=Object.defineProperty;var tt=(g,l,c)=>l in g?Z(g,l,{enumerable:!0,configurable:!0,writable:!0,value:c}):g[l]=c;var m=(g,l,c)=>tt(g,typeof l!="symbol"?l+"":l,c);var D,q;function g(t){return t}const c=(q=(D=globalThis.browser)==null?void 0:D.runtime)!=null&&q.id?globalThis.browser:globalThis.chrome,$={matches:["<all_urls>"],main(){console.log("🎯 StickyNoteAI v2.2 CSS FIXED + MENU POSITIONING - Loading..."),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{M()}):M()}};let s=null,u=!1,b={x:0,y:0},E={x:0,y:0};function M(){console.log("StickyNoteAI: DOM ready, creating widget..."),F(),j(),V(),X()}function F(){const t=document.getElementById("sticky-note-widget");t&&t.remove(),s=document.createElement("div"),s.id="sticky-note-widget",s.innerHTML=`
  ...
  `,document.body.appendChild(t),setTimeout(()=>t.classList.add("open"),10);const e=t.querySelector(".modal-close"),n=t.querySelector(".save-note"),o=t.querySelector(".cancel-note"),i=t.querySelector(".note-input");function r(){t.classList.remove("open"),setTimeout(()=>t.remove(),300)}e==null||e.addEventListener("click",r),o==null||o.addEventListener("click",r),n==null||n.addEventListener("click",()=>{const d=i.value.trim();d&&(H(d),r())}),document.addEventListener("keydown",function d(a){a.key==="Escape"&&(r(),document.removeEventListener("keydown",d))})}function R(){let t=document.querySelector(".notes-panel");t||(t=document.createElement("div"),t.className="notes-panel",t.innerHTML=`
  ...
  `,document.body.appendChild(t),setTimeout(()=>t.classList.add("open"),10);function e(){t.classList.remove("open"),setTimeout(()=>t.remove(),300)}(n=t.querySelector(".modal-close"))==null||n.addEventListener("click",e),(o=t.querySelector(".close-settings"))==null||o.addEventListener("click",e)}function L(){s&&(s.style.display="none")}function A(){s&&(s.style.display="block")}async function H(t){try{const n=(await c.storage.local.get("stickyNotes")).stickyNotes||[],o={id:Date.now().toString(),content:t,timestamp:new Date().toISOString(),url:window.location.href};n.unshift(o),n.length>50&&n.splice(50),await c.storage.local.set({stickyNotes:n}),console.log("Note saved successfully")}catch(e){console.error("Error saving note:",e)}}async function h(){const t=document.getElementById("notes-list");if(t)try{const n=(await c.storage.local.get("stickyNotes")).stickyNotes||[];if(n.length===0){t.innerHTML='<div style="padding: 20px; text-align: center; color: #999;">No notes yet</div>';return}t.innerHTML=n.slice(0,10).map(o=>`
    ...
    `).join(""),t.querySelectorAll(".note-item").forEach(o=>{o.addEventListener("click",()=>{const i=o.dataset.noteId,r=n.find(d=>d.id===i);r&&O(r)})})}catch(e){console.error("Error loading notes:",e)}}function O(t){var i,r,d,a;const e=document.createElement("div");e.className="sticky-modal",e.innerHTML=`
    <div class="modal-content">
      <div class="modal-header">
