var content=function(){"use strict";var yt=Object.defineProperty;var vt=(M,L,c)=>L in M?yt(M,L,{enumerable:!0,configurable:!0,writable:!0,value:c}):M[L]=c;var T=(M,L,c)=>vt(M,typeof L!="symbol"?L+"":L,c);var J,Q;function M(t){return t}const c=(Q=(J=globalThis.browser)==null?void 0:J.runtime)!=null&&Q.id?globalThis.browser:globalThis.chrome,Z={matches:["<all_urls>"],main(){console.log("🎯 StickyNoteAI v2.2 CSS FIXED + MENU POSITIONING - Loading..."),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{X()}):X()}};let a=null,w=!1,P=!1,q={x:0,y:0},N={x:0,y:0},h=null,$;function X(){console.log("StickyNoteAI: DOM ready, creating widget..."),tt(),ut(),ct(),dt()}function tt(){const t=document.getElementById("sticky-note-widget");t&&t.remove(),a=document.createElement("div"),a.id="sticky-note-widget";let e,n;try{e=c.runtime.getURL("smilyface.gif"),$=e,n=c.runtime.getURL("add2.png")}catch(d){console.warn("browser.runtime.getURL failed, using fallback approach:",d);const u=c.runtime.id||chrome.runtime.id;e=`chrome-extension://${u}/smilyface.gif`,$=e,n=`chrome-extension://${u}/add2.png`}console.log("StickyNoteAI: Image URLs:",{smilyFaceUrl:e,add2Url:n}),console.log("StickyNoteAI: Extension ID:",c.runtime.id),console.log("StickyNoteAI: Chrome runtime ID:",chrome.runtime.id),a.innerHTML=`
  ...
  `;const s=e.querySelector(".sticky-note-header");s&&s.after(o);const r=o.querySelector(".edit-btn"),d=o.querySelector(".delete-btn"),u=o.querySelector(".cancel-btn");r==null||r.addEventListener("click",()=>{const l=e.querySelector(".sticky-note-textarea").value.trim();l&&(K(t.id,l),A()),e.remove()}),d==null||d.addEventListener("click",()=>{confirm("Are you sure you want to delete this note?")&&(lt(t.id),A(),e.remove())}),u==null||u.addEventListener("click",()=>{e.remove()});const x=e.querySelector(".sticky-note-textarea");let k;x.removeEventListener("input",()=>{}),x.addEventListener("input",()=>{clearTimeout(k),k=setTimeout(async()=>{const i=x.value.trim();i&&t.id&&(await K(t.id,i),A())},1e3)})}async function K(t,e){try{const o=(await c.storage.local.get("stickyNotes")).stickyNotes||[],s=o.findIndex(r=>r.id===t);s!==-1&&(o[s].content=e,o[s].timestamp=new Date().toISOString(),await c.storage.local.set({stickyNotes:o}))}catch(n){console.error("Error updating note:",n)}}async function lt(t){try{const o=((await c.storage.local.get("stickyNotes")).stickyNotes||[]).filter(s=>s.id!==t);await c.storage.local.set({stickyNotes:o})}catch(e){console.error("Error deleting note:",e)}}function ct(){document.addEventListener("keydown",t=>{if(t.altKey&&t.shiftKey&&(t.code==="KeyN"?(t.preventDefault(),console.log("StickyNoteAI: Alt+Shift+N pressed - Creating new note"),R()):t.code==="KeyW"&&(t.preventDefault(),console.log("StickyNoteAI: Alt+Shift+W pressed - Toggling widget visibility"),G()?V():_())),t.code==="Escape"){const e=document.querySelector(".sticky-modal.open");if(e){t.preventDefault(),e.classList.remove("open"),setTimeout(()=>e.remove(),300);return}const n=document.querySelector(".notes-panel.open");if(n){t.preventDefault(),n.classList.remove("open");return}if(P){t.preventDefault(),C();return}}}),console.log("StickyNoteAI: Local keyboard shortcuts initialized (Alt+Shift+N, Alt+Shift+W, Esc)")}function dt(){c.runtime.onMessage.addListener((t,e,n)=>{if(console.log("StickyNoteAI: Received message:",t),t.action==="toggle-widget"){console.log("StickyNoteAI: Toggle widget command received"),G()?(console.log("StickyNoteAI: Hiding widget"),V()):(console.log("StickyNoteAI: Showing widget"),_()),n({success:!0});return}if(t.action==="new-note"){R(),n({success:!0});return}if(t.action==="create-note-with-selection"){R(t.selectedText||""),n({success:!0});return}if(t.action==="toggleStealth"){const o=document.getElementById("sticky-note-widget");o&&(t.enabled?o.style.opacity="0.3":o.style.opacity="1"),n({success:!0});return}n({success:!1,error:"Unknown action"})})}async function pt(){if(!a)return;const t=a.getBoundingClientRect(),e={x:t.left,y:t.top};try{await c.storage.local.set({widgetPosition:e})}catch(n){console.error("Error saving position:",n)}}async function ut(){if(a){a.style.left="",a.style.top="",a.style.transform="";try{await c.storage.local.remove("widgetPosition")}catch(t){console.error("Error clearing position:",t)}}}function F(t,...e){}const gt={debug:(...t)=>F(console.debug,...t),log:(...t)=>F(console.log,...t),warn:(...t)=>F(console.warn,...t),error:(...t)=>F(console.error,...t)},H=class H extends Event{constructor(e,n){super(H.EVENT_NAME,{}),this.newUrl=e,this.oldUrl=n}};T(H,"EVENT_NAME",B("wxt:locationchange"));let Y=H;function B(t){var e;return`${(e=c==null?void 0:c.runtime)==null?void 0:e.id}:content:${t}`}function mt(t){let e,n;return{run(){e==null&&(n=new URL(location.href),e=t.setInterval(()=>{let o=new URL(location.href);o.href!==n.href&&(window.dispatchEvent(new Y(o,n)),n=o)},1e3))}}}const z=class z{constructor(e,n){T(this,"isTopFrame",window.self===window.top);T(this,"abortController");T(this,"locationWatcher",mt(this));T(this,"receivedMessageIds",new Set);this.contentScriptName=e,this.options=n,this.abortController=new AbortController,this.isTopFrame?(this.listenForNewerScripts({ignoreFirstEvent:!0}),this.stopOldScripts()):this.listenForNewerScripts()}get signal(){return this.abortController.signal}abort(e){return this.abortController.abort(e)}get isInvalid(){return c.runtime.id==null&&this.notifyInvalidated(),this.signal.aborted}get isValid(){return!this.isInvalid}onInvalidated(e){return this.signal.addEventListener("abort",e),()=>this.signal.removeEventListener("abort",e)}block(){return new Promise(()=>{})}setInterval(e,n){const o=setInterval(()=>{this.isValid&&e()},n);return this.onInvalidated(()=>clearInterval(o)),o}setTimeout(e,n){const o=setTimeout(()=>{this.isValid&&e()},n);return this.onInvalidated(()=>clearTimeout(o)),o}requestAnimationFrame(e){const n=requestAnimationFrame((...o)=>{this.isValid&&e(...o)});return this.onInvalidated(()=>cancelAnimationFrame(n)),n}requestIdleCallback(e,n){const o=requestIdleCallback((...s)=>{this.signal.aborted||e(...s)},n);return this.onInvalidated(()=>cancelIdleCallback(o)),o}addEventListener(e,n,o,s){var r;n==="wxt:locationchange"&&this.isValid&&this.locationWatcher.run(),(r=e.addEventListener)==null||r.call(e,n.startsWith("wxt:")?B(n):n,o,{...s,signal:this.signal})}notifyInvalidated(){this.abort("Content script context invalidated"),gt.debug(`Content script "${this.contentScriptName}" context invalidated`)}stopOldScripts(){window.postMessage({type:z.SCRIPT_STARTED_MESSAGE_TYPE,contentScriptName:this.contentScriptName,messageId:Math.random().toString(36).slice(2)},"*")}verifyScriptStartedEvent(e){var r,d,u;const n=((r=e.data)==null?void 0:r.type)===z.SCRIPT_STARTED_MESSAGE_TYPE,o=((d=e.data)==null?void 0:d.contentScriptName)===this.contentScriptName,s=!this.receivedMessageIds.has((u=e.data)==null?void 0:u.messageId);return n&&o&&s}listenForNewerScripts(e){let n=!0;const o=s=>{if(this.verifyScriptStartedEvent(s)){this.receivedMessageIds.add(s.data.messageId);const r=n;if(n=!1,r&&(e!=null&&e.ignoreFirstEvent))return;this.notifyInvalidated()}};addEventListener("message",o),this.onInvalidated(()=>removeEventListener("message",o))}};T(z,"SCRIPT_STARTED_MESSAGE_TYPE",B("wxt:content-script-started"));let U=z;function wt(){}function W(t,...e){}const bt={debug:(...t)=>W(console.debug,...t),log:(...t)=>W(console.log,...t),warn:(...t)=>W(console.warn,...t),error:(...t)=>W(console.error,...t)};return(async()=>{try{const{main:t,...e}=Z,n=new U("content",e);return await t(n)}catch(t){throw bt.error('The content script "content" crashed on startup!',t),t}})()}();
content;
