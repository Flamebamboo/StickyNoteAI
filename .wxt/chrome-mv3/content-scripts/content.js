var content=function(){"use strict";var lt=Object.defineProperty;var ct=(j,F,x)=>F in j?lt(j,F,{enumerable:!0,configurable:!0,writable:!0,value:x}):j[F]=x;var O=(j,F,x)=>ct(j,typeof F!="symbol"?F+"":F,x);var Ce,Te;function j(e){return e}const x=(Te=(Ce=globalThis.browser)==null?void 0:Ce.runtime)!=null&&Te.id?globalThis.browser:globalThis.chrome,Re={matches:["<all_urls>"],main(){console.log("🎯 StickyNoteAI v2.2 CSS FIXED + MENU POSITIONING - Loading..."),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{ye()}):ye()}};let f=null,C=!1,R=!1,ee={x:0,y:0},$={x:0,y:0},L=null,fe,X=null,D={id:"default",data:null};function ye(){console.log("StickyNoteAI: DOM ready, creating widget..."),De(),Qe(),$e(),Ve(),_e()}async function $e(){try{const t=(await x.storage.local.get("sticky-settings"))["sticky-settings"];if(t&&t.activeTheme&&t.activeTheme!=="default"){const o=[{id:"autumn",name:"Autumn",description:"Professional autumn theme with elegant leaf aesthetics",colors:{primary:"linear-gradient(135deg, #8B4513 0%, #A0522D 100%)",secondary:"linear-gradient(135deg, #CD853F 0%, #DAA520 100%)",accent:"#228B22",background:"linear-gradient(145deg, #FFF8DC, #F5DEB3)",noteColors:["rgba(255, 160, 122, 0.95)","rgba(255, 218, 185, 0.95)","rgba(240, 230, 140, 0.95)","rgba(222, 184, 135, 0.95)","rgba(255, 228, 181, 0.95)","rgba(255, 239, 213, 0.95)"]}}].find(i=>i.id===t.activeTheme);o&&(D={id:t.activeTheme,data:o},console.log("StickyNoteAI: Loaded theme:",t.activeTheme),setTimeout(()=>se(t.activeTheme),100))}}catch(e){console.error("StickyNoteAI: Failed to load theme:",e)}}function De(){const e=document.getElementById("sticky-note-widget");e&&e.remove(),f=document.createElement("div"),f.id="sticky-note-widget";let t,n;try{t=x.runtime.getURL("smilyface.gif"),fe=t,n=x.runtime.getURL("add2.png")}catch(r){console.warn("browser.runtime.getURL failed, using fallback approach:",r);const s=x.runtime.id||chrome.runtime.id;t=`chrome-extension://${s}/smilyface.gif`,fe=t,n=`chrome-extension://${s}/add2.png`}console.log("StickyNoteAI: Image URLs:",{smilyFaceUrl:t,add2Url:n}),console.log("StickyNoteAI: Extension ID:",x.runtime.id),console.log("StickyNoteAI: Chrome runtime ID:",chrome.runtime.id),f.innerHTML=`
  ...
  `;const o=document.createElement("style");o.textContent=`
    ...
    /* ...existing code... */
  `,document.head.appendChild(o),document.body.appendChild(f);const i=document.getElementById("smiley-image"),a=document.getElementById("add-image");i&&(i.addEventListener("load",()=>{console.log("✅ Smiley face image loaded successfully")}),i.addEventListener("error",()=>{console.error("❌ Failed to load smiley face image:",t),i.style.display="none"})),a&&(a.addEventListener("load",()=>{console.log("✅ Add2 image loaded successfully")}),a.addEventListener("error",()=>{console.error("❌ Failed to load add2 image:",n),a.style.display="none"})),He(),setTimeout(()=>{se(D.id)},100)}function He(){const e=document.getElementById("main-button"),t=document.getElementById("widget-menu");if(!e||!t)return;let n=0,o={x:0,y:0},i=!1;function a(c,d){if(!f)return{x:c,y:d};const u={width:50,height:50},b=window.innerWidth,h=window.innerHeight,p=10;let m=Math.max(p,c);m=Math.min(b-u.width-p,m);let k=Math.max(p,d);return k=Math.min(h-u.height-p,k),{x:m,y:k}}function r(c,d){if(!f)return{x:c,y:d};const u={width:50,height:50},b=window.innerWidth,h=window.innerHeight,p=20,m=c,k=b-(c+u.width),N=d,W=h-(d+u.height),A=Math.min(m,k,N,W);let B=c,E=d;return(c<0||c+u.width>b||d<0||d+u.height>h)&&(A===m?B=p:A===k?B=b-u.width-p:A===N?E=p:A===W&&(E=h-u.height-p)),{x:B,y:E}}e.addEventListener("mousedown",c=>{c.preventDefault(),n=Date.now(),o={x:c.clientX,y:c.clientY},i=!1;const d=f.getBoundingClientRect();ee.x=c.clientX-d.left,ee.y=c.clientY-d.top,e.classList.add("dragging"),document.addEventListener("mousemove",s),document.addEventListener("mouseup",g)}),e.addEventListener("click",c=>{!C&&!i&&(c.preventDefault(),c.stopPropagation(),R?H():he())}),e.addEventListener("mouseenter",()=>{C||(L&&(clearTimeout(L),L=null),R||he())}),t.addEventListener("mouseenter",()=>{L&&(clearTimeout(L),L=null)}),t.addEventListener("mouseleave",c=>{if(!C){const d=t.getBoundingClientRect(),u=c.clientX,b=c.clientY,h=24;(u<d.left-h||u>d.right+h||b<d.top-h||b>d.bottom+h)&&(L=setTimeout(()=>{H(),L=null},300))}}),e.addEventListener("mouseleave",c=>{if(!C){const d=t.getBoundingClientRect(),u=c.clientX,b=c.clientY,h=24;u>=d.left-h&&u<=d.right+h&&b>=d.top-h&&b<=d.bottom+h||(L=setTimeout(()=>{H(),L=null},200))}});function s(c){const d=Date.now()-n,u=Math.sqrt(Math.pow(c.clientX-o.x,2)+Math.pow(c.clientY-o.y,2));if(!C&&(u>3||d>100)&&(C=!0,i=!0,H(),document.body.style.cursor="grabbing"),C){const b=c.clientX-ee.x,h=c.clientY-ee.y,p=a(b,h);f.style.transform=`translate(${p.x}px, ${p.y}px)`,f.style.left="0",f.style.top="0",$={x:p.x,y:p.y}}}function g(){if(document.removeEventListener("mousemove",s),document.removeEventListener("mouseup",g),e&&e.classList.remove("dragging"),document.body.style.cursor="",C){const c=r($.x,$.y);c.x!==$.x||c.y!==$.y?(f.style.transition="all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",f.style.left=c.x+"px",f.style.top=c.y+"px",f.style.transform="",setTimeout(()=>{f&&(f.style.transition="")},300),$=c):(f.style.left=$.x+"px",f.style.top=$.y+"px",f.style.transform=""),Je()}C=!1,i=!1}let y=0;t==null||t.addEventListener("click",c=>{const u=c.target.dataset.action,b=Date.now();b-y<500||(y=b,u&&(console.log("Menu button clicked:",u),Ye(u)))})}function he(){if(C)return;const e=document.getElementById("widget-menu"),t=document.getElementById("sticky-note-widget");if(e&&t){const n=t.getBoundingClientRect(),o=window.innerHeight;n.top>o/2?e.classList.add("top-positioned"):e.classList.remove("top-positioned"),e.classList.add("open"),R=!0,We()}}function We(){X&&document.removeEventListener("mousemove",X),X=e=>{if(!R||C)return;const t=document.getElementById("sticky-note-widget"),n=document.getElementById("widget-menu");if(!t||!n)return;const o=t.getBoundingClientRect(),i=n.getBoundingClientRect(),a=t.querySelector(".widget-main-button"),r=a?a.getBoundingClientRect():o;Math.random()<.1&&console.log("🖱️ Mouse tracking:",{mouse:{x:e.clientX,y:e.clientY},isMenuOpen:R,isDragging:C});const s=e.clientX,g=e.clientY,y={left:Math.min(r.left,i.left),right:Math.max(r.right,i.right),top:Math.min(r.top,i.top),bottom:Math.max(r.bottom,i.bottom)};console.log("🔍 Rectangle Debug:",{widget:{left:o.left,right:o.right,width:o.width,height:o.height},button:{left:r.left,right:r.right,width:r.width,height:r.height},menu:{left:i.left,right:i.right,width:i.width,height:i.height},combined:y,mouse:{x:s,y:g}});const c=60,d=y.left-c,u=y.right+c,b=y.top-c,h=y.bottom+c;console.log(`📊 Right side analysis:
    Mouse X: ${s}
    ...
    Combined right: ${y.right}
    Right boundary: ${u}
    Distance from boundary: ${s-u}
    Should close when mouse > ${u}`);const p=s<d,m=s>u,k=g<b,N=g>h;(p||m||k||N)&&console.log("⚠️ Boundary checks - SHOULD CLOSE:",{mouse:{x:s,y:g},boundaries:{left:d,right:u,top:b,bottom:h},checks:{leftSide:p,rightSide:m,topSide:k,bottomSide:N},shouldClose:!0});const W=s-r.right,A=s-i.right,B=Math.max(r.right,i.right),E=s>B+c;E&&console.log("🟢 Simple right check - TRIGGERED:",{mouseX:s,buttonRight:r.right,menuRight:i.right,maxRight:B,tolerance:c,threshold:B+c,simpleRightCheck:!0,distanceFromButtonRight:W,distanceFromMenuRight:A}),(p||m||k||N||E)&&(console.log("🔴 CLOSING MENU - Reason:",{leftSide:p,rightSide:m,topSide:k,bottomSide:N,simpleRightCheck:E}),H())},document.addEventListener("mousemove",X)}document.addEventListener("click",e=>{if(!R)return;const t=document.getElementById("sticky-note-widget"),n=document.getElementById("widget-menu");if(!t||!n)return;const o=e.target,i=t.contains(o),a=n.contains(o);!i&&!a&&H()});function H(){const e=document.getElementById("widget-menu");e&&(e.classList.remove("open"),R=!1),L&&(clearTimeout(L),L=null),X&&(document.removeEventListener("mousemove",X),X=null)}function Ye(e){console.log("Menu action triggered:",e),H(),setTimeout(()=>{switch(e){case"add":oe();break;case"notes":Ue();break;case"settings":Oe();break}},100)}function xe(e){if(D.id!=="autumn")return;const t=document.createElement("div");t.className="note-leaves-background",t.style.cssText=`
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  `,document.getElementById("area-leaves-animation")||document.head.insertAdjacentHTML("beforeend",`
    ...
    `);function i(){if(!document.body.contains(e))return;const s=document.createElement("div");s.className="area-falling-leaf";const g=["#CD853F","#DAA520","#D2691E","#B8860B","#A0522D"];s.style.background=g[Math.floor(Math.random()*g.length)],s.style.left=Math.random()*100+"%",s.style.animationDelay=Math.random()*3+"s",s.style.animationDuration=8+Math.random()*4+"s",o.appendChild(s),setTimeout(()=>{s.parentNode&&s.remove()},15e3)}const a=t==="widget"?3:5;for(let s=0;s<a;s++)setTimeout(()=>i(),s*500);const r=setInterval(()=>{document.body.contains(e)?i():clearInterval(r)},3e3);e.appendChild(o),e.style.position="relative",e.style.overflow="hidden"}function se(e){const t=document.getElementById("sticky-note-widget"),n=document.querySelector(".notes-panel");if(e==="autumn"){if(t){t.style.background="",t.style.border="",t.style.color="";const o=t.querySelector(".widget-main-button");if(o){const r=o;r.style.cssText=`
          background: linear-gradient(135deg, #22c55e 0%, #16a34a 100%) !important;
          border: 2px solid rgba(255, 255, 255, 0.3) !important;
          color: white !important;
          box-shadow: 0 4px 16px rgba(34, 197, 94, 0.3) !important;
          position: relative !important;
        `}const i=t.querySelector(".widget-menu");if(i){const r=i;r.style.background="linear-gradient(145deg, rgba(255, 248, 220, 0.95), rgba(245, 222, 179, 0.9))",r.style.border="2px solid rgba(139, 69, 19, 0.4)",r.style.color="#8B4513",r.style.borderRadius="12px",r.style.padding="8px",te(r,"widget")}t.querySelectorAll(".menu-button").forEach(r=>{const s=r;s.style.color="#8B4513",s.style.background="rgba(222, 184, 135, 0.6)",s.style.border="1px solid rgba(139, 69, 19, 0.4)",s.style.borderRadius="6px"})}if(n){n.style.background="linear-gradient(145deg, rgba(255, 248, 220, 0.95), rgba(245, 222, 179, 0.9))",n.style.border="2px solid rgba(139, 69, 19, 0.4)",n.style.color="#8B4513",te(n,"panel");const o=n.querySelector("h3");o&&(o.style.color="#8B4513"),n.querySelectorAll(".recent-note-item").forEach(a=>{const r=a;r.style.background="rgba(255, 228, 196, 0.8)",r.style.border="1px solid rgba(139, 69, 19, 0.3)",r.style.color="#8B4513",r.style.position="relative",r.style.zIndex="2"})}}else{if(t){const o=t.querySelector(".widget-menu");if(o){const r=o;r.style.removeProperty("background"),r.style.removeProperty("border"),r.style.removeProperty("color");const s=r.querySelector(".area-leaves-background");s&&s.remove()}t.querySelectorAll(".menu-button").forEach(r=>{const s=r;s.style.removeProperty("color"),s.style.removeProperty("background"),s.style.removeProperty("border")});const a=t.querySelector(".widget-main-button");if(a){const r=a;r.style.cssText=`
          background: linear-gradient(135deg, #22c55e 0%, #16a34a 100%) !important;
          border: 2px solid rgba(255, 255, 255, 0.3) !important;
          color: white !important;
          box-shadow: 0 4px 16px rgba(34, 197, 94, 0.3) !important;
          position: relative !important;
        `}}if(n){n.style.removeProperty("background"),n.style.removeProperty("border"),n.style.removeProperty("color");const o=n.querySelector(".area-leaves-background");o&&o.remove();const i=n.querySelector("h3");i&&i.style.removeProperty("color"),n.querySelectorAll(".recent-note-item").forEach(r=>{const s=r;s.style.removeProperty("background"),s.style.removeProperty("border"),s.style.removeProperty("color"),s.style.removeProperty("position"),s.style.removeProperty("z-index")})}}}function oe(e=""){if(T&&T.element&&document.body.contains(T.element)){ae(T.element);return}const t=ve(e);if(!t){console.log("StickyNoteAI: Cannot create note - maximum limit reached");return}setTimeout(()=>{const n=t.querySelector(".sticky-note-textarea");n&&(n.focus(),n.setSelectionRange(n.value.length,n.value.length))},100)}let T=null,K=0;const Xe=10;let q=new Map;function ve(e="",t=null){if(t&&q.has(t.id)){const d=q.get(t.id);if(d&&document.body.contains(d))return ae(d),d;q.delete(t.id)}if(!t&&K>=Xe)return console.log("StickyNoteAI: Maximum new notes limit reached (10)"),null;const n=(t==null?void 0:t.id)||Date.now().toString(),o=document.createElement("div");o.className="sticky-note",o.id=`sticky-note-${n}`;let i,a,r,s,g,y;t?(i=t.color||"rgba(255, 251, 147, 0.95)",a=t.title||(e.length>15?e.substring(0,15)+"...":e)||"Edit Note",r=t.fontSize||13,s=t.transparency||.95,g=t.position,y=t.size):(D.id==="autumn"?i="rgba(255, 228, 196, 0.95)":i="rgba(255, 251, 147, 0.95)",a=e?e.length>15?e.substring(0,15)+"...":e:"New Note",r=13,s=.95,g=null,y=null),o.innerHTML=`
